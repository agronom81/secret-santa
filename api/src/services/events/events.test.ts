...
describe('events', () => {
  ...
  scenario('creates a event', async () => {
    const result = await createEvent({
      input: {
        name: 'String',
        date: '2023-12-07T13:14:51.412Z',
        updatedAt: '2023-12-07T13:14:51.412Z',
        sendReminder: true,
      },
    })

    expect(result.name).toEqual('String')
    expect(result.date).toEqual(new Date('2023-12-07T13:14:51.412Z'))
    expect(result.updatedAt).toEqual(new Date('2023-12-07T13:14:51.412Z'))
