...
describe('pairings', () => {
  ...
  scenario('creates a pairing', async (scenario: StandardScenario) => {
    const result = await createPairing({
      input: {
        ...
        updatedAt: '2023-12-07T13:12:49.579Z',
      },
    })
    ...
    expect(result.updatedAt).toEqual(new Date('2023-12-07T13:12:49.579Z'))
  })
  ...
  scenario('updates a pairing', async (scenario: StandardScenario) => {
    ...
    const result = await updatePairing({
      id: original.id,
      input: { updatedAt: '2023-12-08T13:12:49.579Z' },
    })

    expect(result.updatedAt).toEqual(new Date('2023-12-08T13:12:49.579Z'))
  })
